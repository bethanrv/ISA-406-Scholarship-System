...
<body>
    ...
    <div class="container center" style="padding-bottom: 5vh;">
	    <table id="dtBasicExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%" style="padding: 5vh;">
		  <thead>
		    <tr>
		  ...
		  <tbody>
		    <tr>
		      ...
		      <td>2.7</td>
		      <td>04/15/2020</td>
		      <td class="center"><i class="material-icons"> cloud_download </i></td>
		    </tr>
		    <tr>
		      <td>Ella Johnson</td>
		      <td>Sophomore</td>
	...
	<div class="container center">
		<a class="btn waves-effect waves-light" style="background-color: #d94141;"> Download All</a>
	</div>
